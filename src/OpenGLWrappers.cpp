...
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR(2, ui);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR(3, ui);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR(4, ui);

//------------------------------------------------
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_WITH_COUNT(f);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_WITH_COUNT(i);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_WITH_COUNT(ui);

SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(2, f);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(3, f);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(4, f);

SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(2, i);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(3, i);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(4, i);

SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(2, ui);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(3, ui);
SOGLU_DEFINE_SET_PROGRAM_UNIFORM_VECTOR_WITH_COUNT(4, ui);
